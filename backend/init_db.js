    ...
    try {
        ...
        const tables = [
            ...
            `CREATE TABLE doctors (
                ...
                consultationFee VARCHAR(100) DEFAULT 'LKR 1,500',
                address TEXT,
                education TEXT,
                certifications TEXT,
                languages TEXT,
                availability VARCHAR(255) DEFAULT 'Mon-Fri: 9 AM - 5 PM',
        ...
        await connection.query(`INSERT INTO doctors 
            (email, password, name, department, specialization, phone, status, bio, experience, licenseNumber, consultationFee, address, education, certifications, languages, availability, hospital) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [
                'doctor@clinic.com', doctorPass, 'Dr. Jane Smith', 'General Medicine', 'General Practitioner', '1234567890', 'active',
                'Experienced General Practitioner with over 10 years in clinical practice.', '10 years', 'MED123456', 'LKR 1,500',
                '123, Clinic Road, Colombo', JSON.stringify([{ degree: 'MD', institution: 'University of Colombo', year: '2014' }]),
                JSON.stringify(['Board Certified in General Medicine']), JSON.stringify(['English', 'Sinhalese', 'Tamil']),
                'Mon-Fri: 9 AM - 5 PM', 'Community Central Hospital'
            ]);

        await connection.query('INSERT INTO pharmacists (email, password, name, department, phone, status) VALUES (?, ?, ?, ?, ?, ?)',
            ['pharmacist@clinic.com', pharmaPass, 'Jane Pharmacist', 'Pharmacy', '0771234567', 'active']);
