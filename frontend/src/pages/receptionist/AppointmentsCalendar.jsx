...
const AppointmentsCalendar = () => {
  ...
  const appointments = [
    { id: 1, patientName: 'John Smith', time: '09:00 AM', doctor: 'Dr. Sarah Wilson', type: 'Follow-up', status: 'Scheduled', room: 'Room 101' },
    { id: 2, patientName: 'Emily Johnson', time: '10:30 AM', doctor: 'Dr. Michael Chen', type: 'Consultation', status: 'Confirmed', room: 'Room 102' },
    { id: 3, patientName: 'Michael Brown', time: '11:00 AM', doctor: 'Dr. Lisa Park', type: 'New Patient', status: 'Checked-in', room: 'Room 103' },
    { id: 4, patientName: 'Sarah Miller', time: '02:00 PM', doctor: 'Dr. Sarah Wilson', type: 'Check-up', status: 'Scheduled', room: 'Room 101' },
    { id: 5, patientName: 'David Wilson', time: '03:30 PM', doctor: 'Dr. James Lee', type: 'Procedure', status: 'Confirmed', room: 'Room 104' },
  ];
  ...
  const handleCheckIn = (appointmentId) => {
    alert(`Checking in appointment ${appointmentId}`);
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button className="flex-1 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm">
                Today
              </button>
                    ...
                    <div className="flex-1 p-4 min-h-16">
                      {appointmentForSlot ? (
                        <div className={`p-4 rounded-lg ${
                          appointmentForSlot.status === 'Checked-in' ? 'bg-yellow-50 border border-yellow-200' :
