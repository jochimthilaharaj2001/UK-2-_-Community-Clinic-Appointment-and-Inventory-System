...
const PatientAppointments = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            setTimeout(() => {
                setAppointments([
                    { id: 1, doctorName: 'Dr. Sarah Wilson', specialization: 'Cardiologist', date: '2026-01-25', time: '10:00 AM', status: 'Approved' },
                    { id: 2, doctorName: 'Dr. James Davis', specialization: 'General Physician', date: '2026-01-28', time: '02:30 PM', status: 'Pending' },
                ]);
                setDoctors([
                    { id: 101, name: 'Dr. Sarah Wilson', specialization: 'Cardiologist', experience: '12 years', education: 'MD, FACC' },
                    { id: 102, name: 'Dr. James Davis', specialization: 'General Physician', experience: '8 years', education: 'MBBS' },
                    { id: 103, name: 'Dr. Emily Chen', specialization: 'Pediatrician', experience: '10 years', education: 'MD' },
                    { id: 104, name: 'Dr. Michael Brown', specialization: 'Dermatologist', experience: '15 years', education: 'MD, FAAD' },
                ]);
                setLoading(false);
            }, 500);
        } catch (error) {
    ...
    const handleBookAppointment = async (e) => {
        ...
        try {
            // await api.post('/patient/bookings', {
