...
const PatientDashboard = () => {
    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                const statsRes = await api.get('/patient/dashboard/stats');
                setStats({
                    totalAppointments: statsRes.data.totalAppointments,
                    upcomingAppointments: statsRes.data.upcomingAppointments,
                    pastAppointments: statsRes.data.totalAppointments - statsRes.data.upcomingAppointments
                });

                const appointmentsRes = await api.get('/patient/appointments?upcoming=true');
                setRecentAppointments(appointmentsRes.data.map(app => ({
                    id: app.id,
